...
class TestForecastDatasetTransforms:
    ...
    def temp_data_dir(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            fc_data = {
                ...
                "auxiliary_vars": torch.randn(3, 10, 10),
            }
    ...
    def norm_stats(self):
        ...
        return {
            ...
            "aux_mean": torch.zeros(3, 1, 1),
            "aux_std": torch.ones(3, 1, 1),
    ...
    def test_no_transforms(self, temp_data_dir, norm_stats, feature_metadata):
        ...
        assert sample["x"]["predicted_vars"].shape == (5, 10, 10)
        assert sample["x"]["auxiliary_vars"].shape == (3, 10, 10)
    ...
    def test_x_transform_applied(self, temp_data_dir, norm_stats, feature_metadata):
        ...
        assert torch.allclose(
            sample_with_transform["x"]["predicted_vars"],
            sample_no_transform["x"]["predicted_vars"] * 2.0,
        )
        assert torch.allclose(
            sample_with_transform["x"]["auxiliary_vars"],
            sample_no_transform["x"]["auxiliary_vars"] * 2.0,
        )
        assert torch.allclose(
    ...
    def test_y_transform_applied(self, temp_data_dir, norm_stats, feature_metadata):
        ...
        assert torch.allclose(
            sample_with_transform["x"]["predicted_vars"],
            sample_no_transform["x"]["predicted_vars"],
        )
    ...
    def test_both_transforms_applied(self, temp_data_dir, norm_stats, feature_metadata):
        ...
        assert torch.allclose(
            sample_with_transforms["x"]["predicted_vars"],
            sample_no_transform["x"]["predicted_vars"] * 3.0,
        )
        assert torch.allclose(
    ...
    def test_transform_order_after_normalization(self, temp_data_dir, feature_metadata):
        ...
        norm_stats = {
            ...
            "aux_mean": torch.ones(3, 1, 1) * 5.0,
            "aux_std": torch.ones(3, 1, 1) * 2.0,
    ...
    def test_minmax_normalization_with_transforms(self, temp_data_dir, feature_metadata):
        ...
        norm_stats = {
            ...
            "aux_min": torch.zeros(3, 1, 1),
            "aux_max": torch.ones(3, 1, 1),
