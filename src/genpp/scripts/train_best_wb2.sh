...
# Direct
CUDA_VISIBLE_DEVICES=0 pixi run -e gpu  python src/genpp/train.py --config-name base_engression model=cnn_engression_direct data.batch_size=8 model.optimizer.lr=0.001 "model.channels=[16,32]" model/loss_fn=energy_score data=wb2_full_pad_x model/lr_scheduler=reduceLROnPlateau "logger.tags=[engression, es, final, direct]"
CUDA_VISIBLE_DEVICES=0 pixi run -e gpu  python src/genpp/train.py --config-name base_engression model=cnn_engression_direct data.batch_size=8 model.optimizer.lr=0.001 "model.channels=[16,32]" model/loss_fn=patchwise_energy_score data=wb2_full_pad_x model/lr_scheduler=reduceLROnPlateau "logger.tags=[engression, pes, final, direct]"
CUDA_VISIBLE_DEVICES=0 pixi run -e gpu  python src/genpp/train.py --config-name base_engression model=cnn_engression_direct data.batch_size=8 model.optimizer.lr=0.001 "model.channels=[16,32]" model/loss_fn=multiscale_energy_score data=wb2_full_pad_x model/lr_scheduler=reduceLROnPlateau "logger.tags=[engression, mses, final, direct]"
CUDA_VISIBLE_DEVICES=0 pixi run -e gpu  python src/genpp/train.py --config-name base_engression model=cnn_engression_direct data.batch_size=4 model.optimizer.lr=0.001 "model.channels=[16,32]" model/loss_fn=multiscale_patchwise_energy_score data=wb2_full_pad_x model/lr_scheduler=reduceLROnPlateau "logger.tags=[engression, mspes, final, direct]" trainer.accumulate_grad_batches=2
