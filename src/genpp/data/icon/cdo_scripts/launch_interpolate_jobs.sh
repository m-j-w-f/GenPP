...
# Script to launch parallel jobs for each month
...
for year in {2018..2024}; do
    for month in {01..12}; do
        ...
        qsub -N icon_ens_${year}${month} \
             -o /hpc/uhome/extmfeik/GenPP/src/genpp/data/icon/cdo_scripts/logs/icon_ens_${year}${month}.log \
